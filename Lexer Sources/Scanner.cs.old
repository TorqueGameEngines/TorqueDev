	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 3:
				{t.kind = 2; break;}
			case 4:
				if ((ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '&' || ch >= '(' && ch <= '[' || ch >= ']' && ch <= 255)) {AddCh(); goto case 4;}
			...
			case 10:
				if ((ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z')) {AddCh(); goto case 9;}
				else {t.kind = noSym; break;}
			case 11:
				if (ch == ':') {AddCh(); goto case 10;}
				else {t.kind = noSym; break;}
			case 12:
				if ((ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z')) {AddCh(); goto case 12;}
				else if (ch == ':') {AddCh(); goto case 14;}
				else {t.kind = 6; break;}
			case 13:
				if ((ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z')) {AddCh(); goto case 12;}
				else {t.kind = noSym; break;}
			case 14:
			...
			case 15:
				...
				else if (ch == '.') {apx++; AddCh(); goto case 18;}
				else {t.kind = 4; break;}
			case 16:
				if ((ch == '"' || ch == '$' || ch == 39 || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == 92 || ch == '_' || ch >= 'a' && ch <= 'z')) {AddCh(); goto case 2;}
				else {t.kind = noSym; break;}
			case 17:
				if ((ch == '"' || ch == '$' || ch == 39 || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == 92 || ch == '_' || ch >= 'a' && ch <= 'z')) {AddCh(); goto case 4;}
				else {t.kind = noSym; break;}
			case 18:
				if ((ch <= '/' || ch >= ':' && ch <= 255)) {apx++; AddCh(); goto case 8;}
				else if ((ch >= '0' && ch <= '9')) {apx = 0; AddCh(); goto case 7;}
				else {t.kind = noSym; break;}
			case 19:
				{t.kind = 7; break;}
			case 20:
			...
			case 54:
				if ((ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'v' || ch >= 'x' && ch <= 'z')) {AddCh(); goto case 1;}
				else if (ch == 'w') {AddCh(); goto case 67;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 55:
			...
			case 67:
				if ((ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'h' || ch >= 'j' && ch <= 'z')) {AddCh(); goto case 1;}
				else if (ch == 'i') {AddCh(); goto case 70;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 68:
